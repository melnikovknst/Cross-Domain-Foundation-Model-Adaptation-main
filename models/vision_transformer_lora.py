...
from models.layers import Mlp, PatchEmbed, SwiGLUFFNFused, MemEffAttention_lora, NestedTensorBlock as Block
...
def vit_small_lora(patch_size=16, **kwargs):
    model = DinoVisionTransformer(
        ...
        num_heads=6,
        mlp_ratio=4,
        block_fn=partial(Block, attn_class=MemEffAttention_lora),
        **kwargs,
    )
    return model


def vit_base_lora(patch_size=16, **kwargs):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=768,
        depth=12,
